...
//        $fields->addFieldToTab("Root.ProjectInfo", new LiteralField("ProjectInfo", "<h3>Here is Info about this project:</h3>"));
        ...
        $fields->addFieldToTab("Root.ProjectInfo", new LiteralField("ProjectInfo", "<p><a class='btn btn-primary' href='".$controller->Link('doBackup')."' target='_blank'>Create database dump</a></p>"));
        $assetsDirSize = shell_exec("du -sh ".ASSETS_PATH."| awk '{ print $1 }'");
        $fields->addFieldToTab("Root.ProjectInfo", new LiteralField("ProjectInfo", "<p><a class='btn btn-primary' href='".$controller->Link('doDownloadAssets')."' target='_blank'>Download assets</a></p><p>Assets: $assetsDirSize</p>"));
    }
